...
public class FileDownloadView extends FileDownloadResolver implements View {

	private String contentType = MediaType.APPLICATION_OCTET_STREAM_VALUE;  // FileDownload
