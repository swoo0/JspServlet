				...
				<div class="card card-outline card-info">
					<div class="card-header">
						...
						<div class ="card-tools">
							<button type="button" class="btn btn-primary" id="modifyBtn" onclick="modifyForm_go('${notice.nno }');">수 정</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div class="card-body pad">
						<input type="hidden" id="nno" value="${notice.nno }" name='nno' class="form-control">
