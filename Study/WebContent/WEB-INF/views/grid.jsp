...
<script src="<%=request.getContextPath() %>/resources/js/grid.js"></script>
				    ...
				    <div class="jsgrid-grid-header jsgrid-header-scrollbar">
				        <table class="jsgrid-table">
				            <tr class="jsgrid-header-row">
				                ...
				                <th class="jsgrid-header-cell jsgrid-align-center" style="width: 70px;">Address</th>
				                <th class="jsgrid-header-cell jsgrid-align-center" style="width: 80px;">Email</th>
				                <th class="jsgrid-header-cell jsgrid-align-center" style="width: 60px;">Phone</th>
				                ...
				                <th class="jsgrid-header-cell jsgrid-align-center" style="width: 50px;">RegDate</th>
				            </tr>
				            <tr class="jsgrid-row">
...
$(document).on("click", ".jsgrid-row", function() {
