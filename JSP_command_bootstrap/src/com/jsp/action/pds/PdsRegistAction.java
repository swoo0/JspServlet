...
public class PdsRegistAction implements Action{
	...
	// 1. 입력 : commons-fileupload.jar 패키지를 이용하여 FileItem 형태로 변화된
	//  		 MultipartResolver를 받아 PdsVO 를 완성함.
	// 업로드 파일 환경 설정
	...
	public String process(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		try {
			multi = new XSSMultipartHttpServletRequestParser(req, MEMORY_THRESHOLD, MAX_FILE_SIZE, MAX_REQUEST_SIZE);
